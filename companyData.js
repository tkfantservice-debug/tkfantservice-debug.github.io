...
const companyData = [
    ...
    },
   {
    ...
    },
    {
        ...
        serviceDates: {
            '2022-09-17': {
                fans: ['C6(BIGASS)', 'C7(AIREGARD)', 'C8(AIREGARD)', 'C9(BIGASS)', 'C11(AIREGARD)', 'C14(BIGASS)', 'D15(AIREGARD)', 'E15(AIREGARD)', 'F14'],
                reportLinks: {
            ...
            '2023-04-09': {
                fans: ['C6(9)(BIGASS)', 'C7(AIREGARD)', 'C8(AIREGARD)', 'C9(BIGASS)', 'C10(AIREGARD)', 'C11(AIREGARD)', 'C14(6)(BIGASS)', 'D15(8)(AIREGARD)', 'E15(AIREGARD)', 'F14(AIREGARD)'],
                reportLinks: {
            ...
            '2023-10-07': {
                fans: ['B6', 'B7', 'B8', 'B10', 'C6', 'C7', 'C8', 'C9', 'C10', 'C11', 'C14', 'D15', 'E15', 'F14'],
                reportLinks: {
            ...
            '2024-05-04': {
                fans: ['B6(Fan 1)', 'B7(Fan 2)', 'B9(Fan 3)', 'B10(Fan 4)', 'C6(Fan 14)', 'C7(Fan 13)', 'C8(Fan 12)', 'C9(Fan 11)', 'C10(Fan 10)', 'C11(Fan 9)', 'C14(Fan 8)', 'D16(Fan 6)', 'F14(Fan 5)', 'F15 Keluar site(Fan 7)'],
                reportLinks: {
            ...
            '2024-12-07': {
                fans: ['AIREGARD(Fan 2)', 'AIREGARD(Fan 3)', 'AIREGARD(Fan 5)', 'AIREGARD(Fan 6)', 'AIREGARD(Fan 8)', 'AIREGARD(Fan 9)', 'BIGASS(Fan 1)', 'BIGASS(Fan 4)', 'BIGASS(Fan 7)', 'UHF-14(Fan 11)', 'UHF-14(Fan 12)', 'UHF-14(Fan 13)', 'UHF-14(Fan 14)'],
                reportLinks: {
    ...
    { 
        ...
        serviceDates: {
            ...
            '2026-03-11': {
                fans: ['Fan 1'],
                reportLinks: {
                    'Fan 1': 'https://drive.google.com/drive/u/2/folders/1gWFrMAdcq3P3ML98pS_ROVUlW9r9JrpU'
                }
            }
        }
    },
    ...
    },
    {
        ...
        serviceDates: {
            '2023-12-19': {
                fans: ['Fan 1(Site A)', 'Fan 2(Site A)', 'Fan 3(Site A)', 'Fan 4(Site A)', 'Fan 5(Site B)', 'Fan 6(Site B)', 'Fan 7(Site B)', 'Fan 8(D16/D18)', 'Fan 9(D16/D18)', 'Fan 10(D16/D18)'],
                reportLinks: {
    ...
    },
    {
        ...
        serviceDates: {
            '2025-02-12': {
                fans: ['G1', 'G2', 'G3', 'G4', 'G5', 'G6', 'G8', 'G9', 'G10', 'G11', 'G12', 'G14', 'G16', 'G17', 'G18'],
                reportLinks: {
        ...
        serviceDates: {
            '2024-10-08': {
                ...
                reportLinks: {
                    ...
                    'Fan 2': 'https://drive.google.com/drive/u/2/folders/1sWaMYksciKi1ZJiDkKvqf2KY4Tec7Ws'
                }
            }
        }
    },
    ...
    },
    {
        ...
        serviceDates: {
            '2026-04-06': {
                ...
                reportLinks: {
                    'Fan 1': 'https://drive.google.com/drive/u/2/folders/1C-tGZYpMPb1PSp3UpPSWG_8o6HtBpKe4',
                    'Fan 2': 'https://drive.google.com/drive/u/2/folders/1B1rLnEiXyk8rjfB3rMEMznkM6j2nTsCb',
                    'Fan 3': 'https://drive.google.com/drive/u/2/folders/1i4zPHwHjEc8eVmRAfd6G_tZVS7O9PO5C',
                    'Fan 4': 'https://drive.google.com/drive/u/2/folders/14Dth3m6Hh53C49Czuh8v4icYCmkpcVXQ',
...
function getServiceDates(identifier) {
    ...
    return Object.keys(company.serviceDates).sort((a, b) => {
        if (a === 'N/A' || a === 'Photo') return 1;
        if (b === 'N/A' || b === 'Photo') return -1;
...
function formatDate(dateString) {
    if (dateString === 'N/A' || dateString === 'Photo') return dateString;
...
function calculateDaysUntil(dateString) {
    if (dateString === 'N/A' || dateString === 'Photo') return null;
